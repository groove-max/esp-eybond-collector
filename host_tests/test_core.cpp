...
TEST(core_vdtu_capabilities_string) {
  ...
  CHECK_STR(build_vdtu_capabilities(profile, config),
            "esp-collector,0.1.2;features=local_only,no_cloud,wifi_params,endpoint_write;uart=2400,8,1,NONE;"
  ...
  CHECK_STR(build_vdtu_capabilities(profile, config),
            "esp-collector,0.1.2;features=local_only,no_cloud,wifi_params,endpoint_write;uart=9600,8,1,NONE;"
